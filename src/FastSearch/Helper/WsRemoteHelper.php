...
class WsRemoteHelper
{
    ...
    {
        $indexedProductsCountUrl = \FastSearch\Endpoint\WsEndpoint::getCountProductsUrl($publicKey);
        $ch = curl_init();
    ...
    {
        $publicKey = null;
        $publicKeyUrl = \FastSearch\Endpoint\WsEndpoint::getPublicApikeyUrl($secretKey);
        $ch = curl_init();
